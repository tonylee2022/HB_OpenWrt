...
git_sparse_clone https://github.com/sirpdboy/luci-app-netspeedtest luci-app-netspeedtest homebox speedtest-cli netspeedtest
...
git_sparse_clone openwrt-24.10 https://github.com/openwrt/packages net/transmission net/transmission-web-control net/miniupnpd libs/libdeflate libs/libdht libs/libutp libs/libb64
