...
rm -rf feeds/luci/applications/luci-app-passwall  #24.10
rm -rf feeds/luci/applications/luci-app-passwall2  #24.10
rm -rf feeds/luci/applications/luci-app-openclash  #24.10
...
git clone --depth=1 https://github.com/sirpdboy/luci-app-poweroffdevice package/luci-app-poweroffdevice  #24.10
...
git clone --depth=1 https://github.com/jerrykuku/luci-theme-argon package/luci-theme-argon               #24.10
